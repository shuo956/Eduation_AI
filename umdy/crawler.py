...
def collect_courses_info(course_listpath,source_folder):
    ...
    for course in course_list['course']:
        try:
            profix_url=prefix_url+course['url']
            driver.get(profix_url)
            course_source=driver.page_source
            temp_file=open(source_folder+'/'+course['title'].replace(' ','_')+'.txt','w')
...
def collect_reviews(course,driver,review_folder):
    ...
    try:
        ...
        print(course['url'])
#collect_catlog()
sub_list='/home/shuo/Documents/AI_learning/umdy/code/Development.txt'
source_folder='/home/shuo/Documents/AI_learning/umdy'
cat_dir='/home/shuo/Documents/AI_learning/umdy/category_course/'
cate_list=os.listdir(cat_dir)
for cate in cate_list[10:]:
    cate_path=cat_dir+cate
    collect_courses_info(cate_path,source_folder)